;galaxy OS --- The galaxy Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE galaxyOS_VER '1.0.0'	 ;OS version number
	%DEFINE galaxyOS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
option_screen:
	...
	mov cx, 1010101b		; Colour: white text on light blue
	...
	os_init_msg		db ' Welcome to galaxy os ', 0
	os_version_msg		db 'Version ', galaxyOS_VER, 0

	os_init_msg2		db '                         Hardware Information                         ', 0
	os_version_msg2		db 'Version ', galaxyOS_VER, 0

	dialog_string_1		db '    We wormly welcome you to galaxy os.       ', 0
	dialog_string_2		db 'please select INFO to Hardware Infomation   ', 0
...
os_draw_background1:
	...
	mov cx, 0001011b		; Colour: white text on light blue
